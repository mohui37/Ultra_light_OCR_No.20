...
class MobileNetV3(nn.Layer):
    def __init__(self,
        ...
        if model_name == "large":
            ...
            cfg = [
                # k, exp, c,  se,     nl,  s,  pool
                [3, 16, 16, True, 'relu', (small_stride[0], 1), False],
                [3, 72, 24, False, 'relu', (2, 1), False],
                [3, 88, 24, False, 'relu', 1, False],
                [5, 96, 40, True, 'hardswish', (2, 1), False],
                [5, 240, 40, True, 'hardswish', 1, False],
                [5, 240, 40, True, 'hardswish', 1, False],
                [5, 120, 48, True, 'hardswish', 1, False],
                [5, 144, 48, True, 'hardswish', 1, False],
                [5, 288, 96, True, 'hardswish', (2, 1), False],
                [5, 576, 96, True, 'hardswish', 1, False],
                [5, 576, 96, True, 'hardswish', 1, False],
            ]
            cls_ch_squeeze = 576
        else:
